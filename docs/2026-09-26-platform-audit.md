...
5. Private Cloudinary URL expiration depends on configured token-based delivery support (`CLOUDINARY_AUTH_TOKEN_KEY`). Access authorization and upload signatures alone do not prove that an already-issued delivery URL expires.
